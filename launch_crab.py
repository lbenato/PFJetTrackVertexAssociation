...
config.JobType.psetName = 'python/Ntuplizer.py'
...
if __name__ == '__main__':
    ...
    list_of_samples = ["SM_Higgs","VV","WJetsToQQ","WJetsToLNu","DYJetsToQQ","DYJetsToNuNu","DYJetsToLL","ST","TTbar","QCD","signal_VBF","signal_ggH","all","data_obs"]#,"data_obs"
    ...
    workarea = ''
    if  options.lists == "v3":
        from Analyzer.LLP.crab_requests_lists_v3 import * #This list is fine for us!
        #crabConfig = 'crabConfig.py'
        pset = "Ntuplizer.py"
        folder = "v3_preselectionsApplied_noPFcand_06Nov2018" #CHANGE here your crab folder name
        ...
        from Analyzer.LLP.crab_requests_lists_DisplacedJets import * #This list is fine for us!
        #crabConfig = 'crabConfig.py'
        pset = "Ntuplizer.py"
        folder = "test_number_2_on_data"#"v3_preselectionsApplied_noPFcand_correctJEC_09Nov2018" #CHANGE here your crab folder name
        #folder = "v3_preselectionsApplied_noPFcand_correctJEC_09Nov2018" #CHANGE here your crab folder name
        outLFNDirBase = "/store/user/lbenato/"+folder #CHANGE here according to your username!
        workarea = "/nfs/dust/cms/user/lbenato/" + folder #CHANGE here according to your username!
    elif options.lists == "v4":
        from Analyzer.LLP.crab_requests_lists_v4 import * #This list is fine for us!
        #crabConfig = 'crabConfig.py'
        pset = "Ntuplizer.py"
        folder = "v4_preselectionsApplied_14Nov2018"#"v3_preselectionsApplied_noPFcand_correctJEC_09Nov2018" #CHANGE here your crab folder name
        #folder = "v3_preselectionsApplied_noPFcand_correctJEC_09Nov2018" #CHANGE here your crab folder name
        outLFNDirBase = "/store/user/lbenato/"+folder #CHANGE here according to your username!
        workarea = "/nfs/dust/cms/user/lbenato/" + folder #CHANGE here according to your username!
    elif options.lists == "v5":
        from Analyzer.LLP.crab_requests_lists_v5 import * #This list is fine for us!
        pset = "Ntuplizer.py"
        folder = "v5_10Dec2018"#CHANGE here your crab folder name
        outLFNDirBase = "/store/user/lbenato/"+folder #CHANGE here according to your username!
        workarea = "/nfs/dust/cms/user/lbenato/" + folder #CHANGE here according to your username!
    elif options.lists == "trigger":
        from Analyzer.LLP.crab_requests_lists_v5 import * #This list is fine for us!
        pset = "TriggerStudies.py"
        folder = "v0_trigger_14Dec2018"#CHANGE here your crab folder name
        outLFNDirBase = "/store/user/lbenato/"+folder #CHANGE here according to your username!
        workarea = "/nfs/dust/cms/user/lbenato/" + folder #CHANGE here according to your username!
    elif options.lists == "VBFH_ext":
        from Analyzer.LLP.crab_requests_lists_VBFH_Tranche2 import * #This list is fine for us!
        pset = "Ntuplizer.py"
        folder = "v6_20Mar2019"#CHANGE here your crab folder name
        outLFNDirBase = "/store/user/lbenato/"+folder #CHANGE here according to your username!
        workarea = "/nfs/dust/cms/user/lbenato/" + folder #CHANGE here according to your username!
    else:
